...
$heroPoints = [
    ['label' => '01', 'text' => 'Daily vitamins, immunity, and relief essentials in one curated shelf.'],
    ['label' => '02', 'text' => 'Switch between product and medicine types with fast filters.'],
    ['label' => '03', 'text' => 'Use section tags to build a dependable daily routine.'],
];

$sectionHighlights = [
    'daily-vitamins' => 'Core multivitamins and daily boosters to keep energy steady and consistent.',
    'immunity-support' => 'Targeted vitamin C, zinc, and defense blends for stronger everyday support.',
    'pain-relief' => 'Trusted relief options for joints, muscles, and recovery routines.',
];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="zv-container px-1 sm:px-2">
            ...
            <section class="zv-section-lg">
                <div class="mb-4">
                    ...
                    <h2 class="mt-3 text-3xl font-bold">Build a reliable daily routine</h2>
                    <p class="mt-2 text-sm text-slate-600">Everything you need to keep wellness on track, with clear section-level guidance.</p>
                </div>
                <div class="zv-grid-cards cols-3">
                    <?php foreach ($category['sections'] as $section): ?>
                        <?php $sectionId = $section['id']; ?>
                        <article class="zv-glow-card">
                            ...
                            <p class="mt-2 text-sm text-slate-600">
                                <?php echo htmlspecialchars($sectionHighlights[$sectionId] ?? 'Curated essentials that fit everyday wellness routines.', ENT_QUOTES, 'UTF-8'); ?>
                            </p>
            ...
            <section class="zv-section">
                <div class="zv-panel zv-hero-premium p-5 sm:p-6">
                    ...
                    <p class="mt-2 text-sm text-slate-600">Use the search bar and section filters above to lock onto the right daily wellness item.</p>
                </div>
            </section>
        </div>
    </main>
